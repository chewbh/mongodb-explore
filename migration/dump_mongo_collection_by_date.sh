...
############################################################################
# MongoDB migration - dump / backup (delta management)
############################################################################
# dump data from specified date onward from a legacy mongo cluster (e.g. v3.2) collection
...
DATABASE=result
COLLECTION=jobs
QUERY='{created_at: {$gte: new Date("2019-12-05T00:00:00")}}'
